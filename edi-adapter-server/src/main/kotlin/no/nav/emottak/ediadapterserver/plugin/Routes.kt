...
import no.nav.emottak.ediadapterserver.MessageError
import no.nav.emottak.ediadapterserver.herId
import no.nav.emottak.ediadapterserver.messageId
import no.nav.emottak.ediadapterserver.messageIds
import no.nav.emottak.ediadapterserver.model.AppRec
import no.nav.emottak.ediadapterserver.model.Message
import no.nav.emottak.ediadapterserver.senderHerId
import no.nav.emottak.ediadapterserver.toContent
